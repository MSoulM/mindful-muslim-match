...
CREATE TABLE public.mysoul_dna_scores (
...
ALTER TABLE public.mysoul_dna_scores ENABLE ROW LEVEL SECURITY;
...
CREATE TRIGGER update_mysoul_dna_scores_updated_at
BEFORE UPDATE ON public.mysoul_dna_scores
FOR EACH ROW
