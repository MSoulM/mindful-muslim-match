      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4">
          <Button
            ...
            disabled={isLoading}
          >
            {/* Google brand colors intentionally preserved for brand recognition */}
          ...
          <Button
            type="button"
            variant="outline"
            className="flex-1 h-12 rounded-xl bg-foreground text-background border-foreground hover:bg-foreground/90 hover:text-background"
